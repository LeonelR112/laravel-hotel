            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Nueva habitación</li>
                    </ol>
                </nav>                  
            </div>
            <div class="col-12 col-md-11 col-lg-10">
                <form action="{{url('editor/habitaciones/guardar')}}" method="POST">
                    @csrf
                    <h5 class="text-center">Crear nueva habitación:</h5>
                    <article class="row m-0">
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                <label for="input_nro_hab" class="form-label">Número de habitación</label>
                                <input type="number" name="nro_habitacion" class="form-control @error('nro_habitacion') is-invalid @enderror" id="input_nro_hab" placeholder="" value="{{old('nro_habitacion')}}" min="0">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('tipo_habitacion') is-invalid @enderror" name="tipo_habitacion" aria-label="Default select example">
                                    ...
                                    <option value="individual" {{old('tipo_habitacion') == "individual" ? 'selected' : ""}}>Individual</option>
                                    <option value="doble" {{old('tipo_habitacion') == "doble" ? 'selected' : ""}}>Doble</option>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('precio') is-invalid @enderror" name="precio" id="input_precio" placeholder="" value="{{old('precio')}}" min="0">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('disponible') is-invalid @enderror" name="disponible" aria-label="Default select example">
                                    <option value="1" {{old('disponible') == "1" ? 'selected' : ""}}>Si</option>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea name="descripcion" class="form-control @error('descripcion') is-invalid @enderror" id="" cols="30" rows="4">{{old('descripcion')}}</textarea>
